...
def two_equal_clusters_different_covariances():
    '''
    Like linear_equally_spaced_clusters, but all the clusters are evenly placed in a circle
    around the origin
...
if __name__=="__main__":
    ...
    scenario = two_equal_clusters_different_covariances()
...
#    plt.plot(distances,scenario[1],color='b',label='Bayesian Accuracy')
    ...
    plt.xlim([1,20])
    plt.ylim([0,1])
    plt.title('2 equally spaced Gaussian clusters with changing covariances')
